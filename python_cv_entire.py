...
import lstm_entire_model_dataset as LSTMMD
from lstm_entire_model_dataset import metric1 as metric1
from lstm_entire_model_dataset import metric2 as metric2
from lstm_entire_model_dataset import metric3 as metric3
from lstm_entire_model_dataset import StockDatasetCV as StockDatasetCV
from lstm_entire_model_dataset import CV_Data_Spliter as CV_Data_Spliter
from lstm_entire_model_dataset import CV_train_Spliter as CV_train_Spliter
import os
import csv
...
def train(model, partition, optimizer, loss_fn, args):
    ...
    for i, (X, y) in enumerate(trainloader):
        ...
        y_true = y[:, :].squeeze().float().to(args.device)  ## index-3은 종가를 의미(dataframe 상에서)
...
def test(model, partition, args):
    ...
    with torch.no_grad():
        ...
        for i, (X, y) in enumerate(testloader):
            ...
            reformed_y_pred = y_pred.squeeze() * (args.data_max - args.data_min) + args.data_min
            reformed_y_true = y_true.squeeze() * (args.data_max - args.data_min) + args.data_min
...
with open(args.save_file_path + '\\' + 'result_t.csv', 'w', encoding='utf-8', newline='') as f:
    ...
    for i in model_list:
        ...
        for j in data_list:
            ...
            args.data_min, args.data_max = splitted_test_train.min_max()
